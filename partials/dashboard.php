...
<body class="bg-orange text-light">
    <div class="container my-5">
        <a href="../"><button class="btn btn-dark text-light px-r">Back</button></a>
        <a href="logout.php"><button class="btn btn-dark text-light px-r">Logout</button></a>
            ...
            <div class="col-md-7">
                ...
                ?>
                        ...
                        <form action="../action/voting.php" method="post">
                            <input type="hidden" name="groupvotes" value="<?php echo $groups[$i]['voter'] ?>">
                            <input type="hidden" name="groupid" value="<?php echo $groups[$i]['id'] ?>">

                            <?php
                            if ($_SESSION['status'] == 1) {
                            ?>
                                <label class="bg-success my-4 text-white px-3">voted</label>
                            <?php
